      ...
      <div className="mx-auto max-w-6xl px-6 py-12 md:py-16">
        ...
        <div className="mb-10">
          ...
          <p className="mt-2 text-muted-foreground">
            Discover verified MVPs ready for their next operator
          </p>
        </div>
        ...
        <p className="mb-6 text-sm text-muted-foreground">
          ...
          {displayListings.length === 1 ? "listing" : "listings"} found
          {q && (
            <>
              {" "}
              for &ldquo;{q}&rdquo;
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <span>
                          {listing.monthly_users > 0
                            ? `${listing.monthly_users.toLocaleString()} users`
                            : "Pre-launch"}
                        </span>
                      </div>
          ...
          <div className="text-center py-20 rounded-2xl border border-dashed border-border">
            ...
            <p className="mt-2 text-muted-foreground">
              {q || model
                ...
                : "Be the first to list your MVP on ShipFlip!"}
            </p>
